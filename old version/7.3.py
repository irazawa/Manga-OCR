# Manga OCR & Typeset Tool v7.3
# Ditingkatkan oleh Gemini
#
# --- FITUR BARU DI v7.3 (Perbaikan Bug Kritis) ---
# 1. Perbaikan Konversi Gambar: Memperbaiki `TypeError` fatal yang terjadi
#    saat menggambar ulang area yang sudah di-typeset. Logika konversi dari
#    gambar PIL ke QImage telah diganti dengan metode yang benar dan stabil
#    untuk mencegah crash.
...
class MangaOCRApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Manga OCR & Typeset Tool v7.3")
    ...
    def draw_single_area(self, painter, area):
        ...
        # PERBAIKAN v7.3: Konversi PIL ke QImage yang benar
    ...
    def save_project(self):
        ...
        try:
            ...
            self.setWindowTitle(f"Manga OCR & Typeset Tool v7.3 - {os.path.basename(self.current_project_path)}"); self.autosave_timer.start(); return True
        except Exception as e:
    ...
    def load_project(self):
        ...
        try:
            ...
            self.current_project_path = filePath; self.setWindowTitle(f"Manga OCR & Typeset Tool v7.3 - {os.path.basename(self.current_project_path)}"); self.autosave_timer.start()

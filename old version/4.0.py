# Manga OCR & Typeset Tool v4.0
# Ditingkatkan oleh Gemini
#
# --- FITUR BARU DI v4.0 ---
# 1. Kontrol Penggunaan AI: Menambahkan checkbox untuk mengaktifkan/menonaktifkan
#    fitur koreksi teks via Gemini API, memberi user kontrol penuh.
# 2. Pelacakan Penggunaan Harian: Aplikasi kini melacak jumlah panggilan API
#    harian dan me-resetnya secara otomatis. Data disimpan secara lokal.
# 3. Info Penggunaan & Batasan: Menu "Help" kini menampilkan jumlah penggunaan
#    API hari ini dan informasi mengenai batasan gratis dari Gemini API.
#
# --- FITUR SEBELUMNYA ---
# - Perbaikan Model AI ke 'gemini-1.5-flash-latest'
...
class MangaOCRApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Manga OCR & Typeset Tool v4.0")
        ...
        self.usage_data = {'date': str(date.today()), 'count': 0}
    ...
    def setup_right_panel(self, right_panel):
        ...
        # NEW: Checkbox for AI Correction
    ...
    def correct_text_with_gemini(self, text_to_correct):
        ...
        self.increment_usage_count() # Lacak penggunaan sebelum memanggil API
    ...
    def increment_usage_count(self):
        self.load_usage_data() # Ensure data is current
        self.usage_data['count'] += 1
        self.save_usage_data()
        print(f"Gemini API call count for today: {self.usage_data['count']}")
    ...
    def save_project(self):
        ...
        try:
            ...
            self.setWindowTitle(f"Manga OCR & Typeset Tool v4.0 - {os.path.basename(self.current_project_path)}")
    ...
    def show_about_dialog(self):
        ...
        usage_count = self.usage_data.get('count', 0)
        
        # Informasi batasan gratis untuk Gemini 1.5 Flash
        free_limit_daily = 50
        
        about_text = (
            f"<b>Manga OCR & Typeset Tool v4.0</b><br><br>"
            ...
            f" - Today's API Calls: <b>{usage_count} / {free_limit_daily}</b><br>"
            f" - Free Tier Limit: <b>{free_limit_daily} requests per day</b>.<br>"
            f"<i>The count resets automatically each day.</i><br><br>"
            f"Copyright © 2024"
        )

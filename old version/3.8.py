# Manga OCR & Typeset Tool v3.8
# Ditingkatkan oleh Gemini
#
# --- FITUR BARU DI v3.8 ---
# 1. Integrasi AI (Gemini): Menambahkan fungsi untuk memperbaiki teks hasil OCR
#    secara otomatis menggunakan Gemini API sebelum proses penerjemahan.
#    Ini secara signifikan meningkatkan kualitas teks dan hasil terjemahan.
#
# --- FITUR SEBELUMNYA ---
...
class MangaOCRApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Manga OCR & Typeset Tool v3.8")
    ...
    def save_project(self):
        ...
        try:
            ...
            self.setWindowTitle(f"Manga OCR & Typeset Tool v3.8 - {os.path.basename(self.current_project_path)}")
    ...
    def show_about_dialog(self):
        QMessageBox.about(self, "About Manga OCR & Typeset Tool",
            "<b>Manga OCR & Typeset Tool v3.8</b><br><br>"
